...
use crate::{interface::TidbitInterface, params::SixteenDistParams, runtime::SixteenDistRuntime};

pub struct SixteenDist {
    params: Arc<SixteenDistParams>,
    runtime: Runtime<SixteenDistParams, SixteenDistRuntime>
}

impl Default for SixteenDist {
    fn default() -> Self {
        let params = Arc::new(SixteenDistParams::default());
        let runtime = Runtime::new(params.clone(), SixteenDistRuntime::new(params.clone()));
...
impl MlemPlugin<SixteenDistParams> for SixteenDist {
...
impl ClapPlugin for SixteenDist {
...
impl Vst3Plugin for SixteenDist {
...
nih_export_clap!(SixteenDist);
nih_export_vst3!(SixteenDist);
