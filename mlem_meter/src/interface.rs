...
use mlem_base::{base::mlem_interface::MlemInterface, interface::{param_toggle::{self}, utils::{parameter_grid, parameter_label}}};
...
impl MlemInterface<MeterParams> for MeterInterface {
    ...
    fn update_bar(&mut self, ui: &mut Ui, _ctx: &Context, _setter: &ParamSetter) {
