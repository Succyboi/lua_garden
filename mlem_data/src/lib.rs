...
use crate::{interface::MeterInterface, params::DataParams, runtime::DataRuntime};

pub struct Data {
    params: Arc<DataParams>,
    runtime: Runtime<DataParams, DataRuntime>
}

impl Default for Data {
    fn default() -> Self {
        let params = Arc::new(DataParams::default());
        let runtime = Runtime::new(params.clone(), DataRuntime::new(params.clone()));
...
impl MlemPlugin<DataParams> for Data {
...
nih_export_clap!(Data);
nih_export_vst3!(Data);
